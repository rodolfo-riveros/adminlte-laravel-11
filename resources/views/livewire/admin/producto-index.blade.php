                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="stock"
                                placeholder="Escriba el stock del producto" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input type="file" name="manual" class="custom-file-input" id="manual"
                                    onchange="updateFileName(this)" accept=".pdf" required>
                ...
                <tbody>
                    @foreach ($productos as $producto)
                        <tr>
                            ...
                            <td width="10px">
                                <a href="" class="btn btn-warning" data-toggle="modal"
                                    data-target="#editModal{{ $producto->id }}"><i class="fas fa-edit"></i></a>
                            </td>
                            <td width="10px">
                        ...
                        <div class="modal fade" id="editModal{{ $producto->id }}" tabindex="-1" role="dialog"
                            aria-labelledby="editModal{{ $producto->id }}Label" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="editModal{{ $producto->id }}Label">Editar
                                            producto</h5>
                                        ...
                                        <div class="modal-body">
                                                ...
                                                <select class="form-control" name="category_id">
                                                    ...
                                                    @foreach ($categories as $category)
                                                        <option value="{{ $category->id }}"
                                                            {{ $producto->category_id == $category->id ? 'selected' : '' }}>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="name"
                                                    id="name{{ $producto->id }}" value="{{ $producto->name }}"
                                                    required>
                                            </div>
                                            <div class="form-group">
