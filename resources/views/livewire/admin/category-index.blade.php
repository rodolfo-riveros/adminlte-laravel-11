                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="description" placeholder="Escriba una descrición" required>
                        </div>
                    </div>
                </div>
                <div class="row">
                                ...
                                <form action="{{ route('admin.categoria.update', $categorias->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="name" id="name{{ $categorias->id}}" value="{{ $categorias->name}}">
                                        </div>
                                        <div class="form-group">
